...
export default class GetUserFollowing extends Routine {
    ...
    async _openFollowersList () {
        const followersButtonSelector = "a[href$=\"following/\"]";
    ...
    async _fetchAllFollowers () {
        ...
        const followersListWrapper = "div[role=dialog] > div:nth-child(3)";
